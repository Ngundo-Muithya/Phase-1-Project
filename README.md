...
For more information, visit the [Jupyter Notebook](./Notebook.ipynb), the [Tableau Dashboard](https://public.tableau.com/views/MadrigalElectromotivesLowestRiskAircraftAnalysis/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) or the [Presentation](./Presentation.pdf).
